        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.videos.store") }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('seo_keywords_uz') ? 'is-invalid' : '' }}" value="{{ old('seo_keywords_uz') }}" name="seo_keywords_uz" id="seo_keywords_uz">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('seo_keywords_ru') ? 'is-invalid' : '' }}" value="{{ old('seo_keywords_ru') }}" name="seo_keywords_ru" id="seo_keywords_ru">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('seo_keywords_en') ? 'is-invalid' : '' }}" value="{{ old('seo_keywords_en') }}" name="seo_keywords_en" id="seo_keywords_en">
