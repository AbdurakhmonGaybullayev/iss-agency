<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @endcan
        @can('home_direction_section_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.home-direction-sections.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/home-direction-sections") || request()->is("admin/home-direction-sections/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-book c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.homeDirectionSection.title') }}
                </a>
            </li>
        @endcan
        @can('cooperation_offer_text_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.cooperation-offer-texts.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/cooperation-offer-texts") || request()->is("admin/cooperation-offer-texts/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-handshake c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.cooperationOfferText.title') }}
                </a>
            </li>
        @endcan
        @can('country_access')
        ...
        @endcan
        @can('seo_table_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.seo-tables.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/seo-tables") || request()->is("admin/seo-tables/*") ? "c-active" : "" }}">
                    <i class="fa-fw fab fa-google c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.seoTable.title') }}
                </a>
            </li>
        @endcan
        @can('team_access')
