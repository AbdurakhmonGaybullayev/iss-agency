    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.teams.update", [$team->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number') ? 'is-invalid' : '' }}" type="number" name="number" id="number" value="{{ old('number', $team->number) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('full_name_uz') ? 'is-invalid' : '' }}" type="text" name="full_name_uz" id="full_name_uz" value="{{ old('full_name_uz', $team->full_name_uz) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('full_name_ru') ? 'is-invalid' : '' }}" type="text" name="full_name_ru" id="full_name_ru" value="{{ old('full_name_ru', $team->full_name_ru) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('full_name_en') ? 'is-invalid' : '' }}" type="text" name="full_name_en" id="full_name_en" value="{{ old('full_name_en', $team->full_name_en) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('occupation_uz') ? 'is-invalid' : '' }}" type="text" name="occupation_uz" id="occupation_uz" value="{{ old('occupation_uz', $team->occupation_uz) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('occupation_ru') ? 'is-invalid' : '' }}" type="text" name="occupation_ru" id="occupation_ru" value="{{ old('occupation_ru', $team->occupation_ru) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('occupation_en') ? 'is-invalid' : '' }}" type="text" name="occupation_en" id="occupation_en" value="{{ old('occupation_en', $team->occupation_en) }}" required>
