...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    // Seo Table
    Route::post('seo-tables/media', 'SeoTableController@storeMedia')->name('seo-tables.storeMedia');
    Route::post('seo-tables/ckmedia', 'SeoTableController@storeCKEditorImages')->name('seo-tables.storeCKEditorImages');
    Route::resource('seo-tables', 'SeoTableController', ['except' => ['create', 'store', 'destroy']]);
