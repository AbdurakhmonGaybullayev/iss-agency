...
class DocumentController extends Controller
{
    ...
    public function index()
    {
        ...
        $documents = Document::with(['user', 'university', 'direction', 'media'])->get();
        ...
        return view('admin.documents.index', compact('documents', 'users', 'universities', 'directions'));
    }
    ...
    public function show(Document $document)
    {
        ...
        $document->load('user', 'university', 'direction');
