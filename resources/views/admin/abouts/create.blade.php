    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.abouts.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('decription_uz') ? 'is-invalid' : '' }}" name="decription_uz" id="decription_uz">{!! old('decription_uz') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description_ru') ? 'is-invalid' : '' }}" name="description_ru" id="description_ru">{!! old('description_ru') !!}</textarea>
