...
class PermissionsTableSeeder extends Seeder
{
    public function run()
    {
        $permissions = [
            ...
            [
                'id'    => 93,
                'title' => 'cooperation_offer_text_edit',
            ],
            [
                'id'    => 94,
                'title' => 'cooperation_offer_text_show',
            ],
            [
                'id'    => 95,
                'title' => 'cooperation_offer_text_access',
            ],
            [
                'id'    => 96,
            ...
            [
                'id'    => 101,
                'title' => 'home_direction_section_edit',
            ],
            [
                'id'    => 102,
                'title' => 'home_direction_section_show',
            ],
            [
                'id'    => 103,
                'title' => 'home_direction_section_access',
            ],
            [
                'id'    => 104,
