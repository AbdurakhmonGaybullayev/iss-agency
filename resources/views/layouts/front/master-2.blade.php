...
<div class="navbar-area">
                    ...
                    <ul class="topbar-right text-md-right text-center">
                        <li class="social-area">
                            ...
                            @foreach($languages as $language)
                                @if($language != $locale)
                                    <a class="next-lang" href="@php $url = URL::full(); $url = str_replace($locale,$language,$url); echo $url; @endphp"><img
    ...
    <nav class="navbar bg-white navbar-area-1 navbar-area navbar-expand-lg">
        <div class="container nav-container">
            ...
            <div class="logo">
                <a href="{{route('home',$locale)}}"><img class="iss-logo" style="width:200px;margin-top: -15px; margin-bottom: -15px" src="{{asset('front/assets/img/logo-iss-2.png')}}"
                                                         alt="img"></a>
            </div>
