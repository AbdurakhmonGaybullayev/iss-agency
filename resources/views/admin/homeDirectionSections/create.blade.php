...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.homeDirectionSection.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.home-direction-sections.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="number">{{ trans('cruds.homeDirectionSection.fields.number') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.homeDirectionSection.fields.number_helper') }}</span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="short_description_uz">{{ trans('cruds.homeDirectionSection.fields.short_description_uz') }}</label>
                <input class="form-control {{ $errors->has('short_description_uz') ? 'is-invalid' : '' }}" type="text" name="short_description_uz" id="short_description_uz" value="{{ old('short_description_uz', '') }}">
            ...
            <div class="form-group">
                <label for="short_description_ru">{{ trans('cruds.homeDirectionSection.fields.short_description_ru') }}</label>
                <input class="form-control {{ $errors->has('short_description_ru') ? 'is-invalid' : '' }}" type="text" name="short_description_ru" id="short_description_ru" value="{{ old('short_description_ru', '') }}">
            ...
            <div class="form-group">
                <label for="short_description_en">{{ trans('cruds.homeDirectionSection.fields.short_description_en') }}</label>
