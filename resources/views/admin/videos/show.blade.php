        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.video.fields.short_description_uz') }}
                        </th>
                        <td>
                            {{ $video->short_description_uz }}
                        </td>
                    </tr>
                    <tr>
                        <th>
                            {{ trans('cruds.video.fields.short_description_ru') }}
                        </th>
                        <td>
                            {{ $video->short_description_ru }}
                        </td>
                    </tr>
                    <tr>
                        <th>
                            {{ trans('cruds.video.fields.short_description_en') }}
                        </th>
                        <td>
                            {{ $video->short_description_en }}
                        </td>
                    </tr>
                    <tr>
                        <th>
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.video.fields.seo_keywords_uz') }}
                        </th>
                        <td>
                            {{ $video->seo_keywords_uz }}
                        </td>
                    </tr>
                    <tr>
                        <th>
                            {{ trans('cruds.video.fields.seo_keywords_ru') }}
                        </th>
                        <td>
                            {{ $video->seo_keywords_ru }}
                        </td>
                    </tr>
                    <tr>
                        <th>
                            {{ trans('cruds.video.fields.seo_keywords_en') }}
                        </th>
                        <td>
                            {{ $video->seo_keywords_en }}
                        </td>
                    </tr>
                    </tbody>
                </table>
