        ...
        <form method="POST" action="{{ route("admin.universities.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('top') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="top" id="top" value="1" required {{ old('top', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ielts') ? 'is-invalid' : '' }}" type="number" name="ielts" id="ielts" value="{{ old('ielts', '') }}" step="0.01" required>
                @if($errors->has('ielts'))
                    <div class="invalid-feedback">
                        {{ $errors->first('ielts') }}
                    </div>
