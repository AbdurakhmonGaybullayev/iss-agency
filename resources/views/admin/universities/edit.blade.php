    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.universities.update", [$university->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number') ? 'is-invalid' : '' }}" type="number" name="number" id="number" value="{{ old('number', $university->number) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_uz') ? 'is-invalid' : '' }}" type="text" name="name_uz" id="name_uz" value="{{ old('name_uz', $university->name_uz) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_ru') ? 'is-invalid' : '' }}" type="text" name="name_ru" id="name_ru" value="{{ old('name_ru', $university->name_ru) }}" required>
            ...
            <div class="form-group">
                <label class="required" for="rank">{{ trans('cruds.university.fields.rank') }}</label>
                <input class="form-control {{ $errors->has('rank') ? 'is-invalid' : '' }}" type="number" name="rank" id="rank" value="{{ old('rank', $university->rank) }}" step="1" required>
                @if($errors->has('rank'))
                    <div class="invalid-feedback">
                        {{ $errors->first('rank') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.university.fields.rank_helper') }}</span>
            </div>
            <div class="form-group">
                <div class="form-check {{ $errors->has('top') ? 'is-invalid' : '' }}">
                    <input type="hidden" name="top" value="0">
                    <input class="form-check-input" type="checkbox" name="top" id="top" value="1" {{ $university->top || old('top', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('short_description_uz') ? 'is-invalid' : '' }}" name="short_description_uz" id="short_description_uz" required>{{ old('short_description_uz', $university->short_description_uz) }}</textarea>
            ...
            <div class="form-group">
                <label class="required" for="short_description_ru">{{ trans('cruds.university.fields.short_description_ru') }}</label>
                <textarea class="form-control {{ $errors->has('short_description_ru') ? 'is-invalid' : '' }}" name="short_description_ru" id="short_description_ru" required>{{ old('short_description_ru', $university->short_description_ru) }}</textarea>
            ...
            <div class="form-group">
                <label class="required" for="short_description_en">{{ trans('cruds.university.fields.short_description_en') }}</label>
                <textarea class="form-control {{ $errors->has('short_description_en') ? 'is-invalid' : '' }}" name="short_description_en" id="short_description_en" required>{{ old('short_description_en', $university->short_description_en) }}</textarea>
            ...
            <div class="form-group">
                <label class="required" for="article_description_uz">{{ trans('cruds.university.fields.article_description_uz') }}</label>
                <textarea class="form-control ckeditor {{ $errors->has('article_description_uz') ? 'is-invalid' : '' }}" name="article_description_uz" id="article_description_uz" required>{!! old('article_description_uz', $university->article_description_uz) !!}</textarea>
            ...
            <div class="form-group">
                <label class="required" for="article_description_ru">{{ trans('cruds.university.fields.article_description_ru') }}</label>
                <textarea class="form-control ckeditor {{ $errors->has('article_description_ru') ? 'is-invalid' : '' }}" name="article_description_ru" id="article_description_ru" required>{!! old('article_description_ru', $university->article_description_ru) !!}</textarea>
            ...
            <div class="form-group">
                <label class="required" for="article_description_en">{{ trans('cruds.university.fields.article_description_en') }}</label>
                <textarea class="form-control ckeditor {{ $errors->has('article_description_en') ? 'is-invalid' : '' }}" name="article_description_en" id="article_description_en" required>{!! old('article_description_en', $university->article_description_en) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('directions') ? 'is-invalid' : '' }}" name="directions[]" id="directions" multiple required>
                    @foreach($directions as $id => $direction)
                        <option value="{{ $id }}" {{ (in_array($id, old('directions', [])) || $university->directions->contains($id)) ? 'selected' : '' }}>{{ $direction }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('certificates') ? 'is-invalid' : '' }}" name="certificates[]" id="certificates" multiple required>
                    @foreach($certificates as $id => $certificate)
                        <option value="{{ $id }}" {{ (in_array($id, old('certificates', [])) || $university->certificates->contains($id)) ? 'selected' : '' }}>{{ $certificate }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ielts') ? 'is-invalid' : '' }}" type="number" name="ielts" id="ielts" value="{{ old('ielts', $university->ielts) }}" step="0.5" required>
                @if($errors->has('ielts'))
                    <div class="invalid-feedback">
                        {{ $errors->first('ielts') }}
                    </div>
            ...
            <div class="form-group">
                <label class="required" for="seo_keywords_uz">{{ trans('cruds.university.fields.seo_keywords_uz') }}</label>
                <input class="form-control {{ $errors->has('seo_keywords_uz') ? 'is-invalid' : '' }}" value="{{ old('seo_keywords_uz', $university->seo_keywords_uz) }}" name="seo_keywords_uz" id="seo_keywords_uz" required>
                @if($errors->has('seo_keywords_uz'))
                    <div class="invalid-feedback">
                        {{ $errors->first('seo_keywords_uz') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.university.fields.seo_keywords_uz_helper') }}</span>
            </div>
            <div class="form-group">
                <label class="required" for="seo_keywords_ru">{{ trans('cruds.university.fields.seo_keywords_ru') }}</label>
                <input class="form-control {{ $errors->has('seo_keywords_ru') ? 'is-invalid' : '' }}" value="{{ old('seo_keywords_ru', $university->seo_keywords_ru) }}" name="seo_keywords_ru" id="seo_keywords_ru" required>
                @if($errors->has('seo_keywords_ru'))
                    <div class="invalid-feedback">
                        {{ $errors->first('seo_keywords_ru') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.university.fields.seo_keywords_ru_helper') }}</span>
            </div>
            <div class="form-group">
                <label class="required" for="seo_keywords_en">{{ trans('cruds.university.fields.seo_keywords_en') }}</label>
                <input class="form-control {{ $errors->has('seo_keywords_en') ? 'is-invalid' : '' }}" value="{{ old('seo_keywords_en', $university->seo_keywords_en) }}" name="seo_keywords_en" id="seo_keywords_en" required>
                @if($errors->has('seo_keywords_en'))
                    <div class="invalid-feedback">
                        {{ $errors->first('seo_keywords_en') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.university.fields.seo_keywords_en_helper') }}</span>
            </div>
            <div class="form-group">
