<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-universityDocuments">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($documents as $key => $document)
                        <tr data-entry-id="{{ $document->id }}">
                            ...
                            <td>
                                @foreach($document->certificates as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-universityDocuments:not(.ajaxTable)').DataTable({ buttons: dtButtons })
