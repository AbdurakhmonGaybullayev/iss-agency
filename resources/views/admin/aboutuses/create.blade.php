    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.aboutuses.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('article_uz') ? 'is-invalid' : '' }}" name="article_uz" id="article_uz" required>{!! old('article_uz') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('article_en') ? 'is-invalid' : '' }}" name="article_en" id="article_en" required>{!! old('article_en') !!}</textarea>
