    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.headers.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('about_us_uz') ? 'is-invalid' : '' }}" type="text" name="about_us_uz" id="about_us_uz" value="{{ old('about_us_uz', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('about_us_ru') ? 'is-invalid' : '' }}" type="text" name="about_us_ru" id="about_us_ru" value="{{ old('about_us_ru', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('about_us_en') ? 'is-invalid' : '' }}" type="text" name="about_us_en" id="about_us_en" value="{{ old('about_us_en', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('qanda_uz') ? 'is-invalid' : '' }}" type="text" name="qanda_uz" id="qanda_uz" value="{{ old('qanda_uz', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('qanda_ru') ? 'is-invalid' : '' }}" type="text" name="qanda_ru" id="qanda_ru" value="{{ old('qanda_ru', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('qanda_en') ? 'is-invalid' : '' }}" type="text" name="qanda_en" id="qanda_en" value="{{ old('qanda_en', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cooperation_uz') ? 'is-invalid' : '' }}" type="text" name="cooperation_uz" id="cooperation_uz" value="{{ old('cooperation_uz', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cooperation_ru') ? 'is-invalid' : '' }}" type="text" name="cooperation_ru" id="cooperation_ru" value="{{ old('cooperation_ru', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cooperation_en') ? 'is-invalid' : '' }}" type="text" name="cooperation_en" id="cooperation_en" value="{{ old('cooperation_en', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('universities_uz') ? 'is-invalid' : '' }}" type="text" name="universities_uz" id="universities_uz" value="{{ old('universities_uz', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('universities_ru') ? 'is-invalid' : '' }}" type="text" name="universities_ru" id="universities_ru" value="{{ old('universities_ru', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('universities_en') ? 'is-invalid' : '' }}" type="text" name="universities_en" id="universities_en" value="{{ old('universities_en', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gallery_uz') ? 'is-invalid' : '' }}" type="text" name="gallery_uz" id="gallery_uz" value="{{ old('gallery_uz', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gallery_ru') ? 'is-invalid' : '' }}" type="text" name="gallery_ru" id="gallery_ru" value="{{ old('gallery_ru', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gallery_en') ? 'is-invalid' : '' }}" type="text" name="gallery_en" id="gallery_en" value="{{ old('gallery_en', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('blog_uz') ? 'is-invalid' : '' }}" type="text" name="blog_uz" id="blog_uz" value="{{ old('blog_uz', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('blog_ru') ? 'is-invalid' : '' }}" type="text" name="blog_ru" id="blog_ru" value="{{ old('blog_ru', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('blog_en') ? 'is-invalid' : '' }}" type="text" name="blog_en" id="blog_en" value="{{ old('blog_en', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('branch_uz') ? 'is-invalid' : '' }}" type="text" name="branch_uz" id="branch_uz" value="{{ old('branch_uz', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('branch_ru') ? 'is-invalid' : '' }}" type="text" name="branch_ru" id="branch_ru" value="{{ old('branch_ru', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('branch_en') ? 'is-invalid' : '' }}" type="text" name="branch_en" id="branch_en" value="{{ old('branch_en', '') }}" required>
