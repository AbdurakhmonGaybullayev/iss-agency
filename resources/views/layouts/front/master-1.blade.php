...
<div class="td-search-popup" id="td-search-popup">
    <form action="{{route('search',$locale)}}" method="get" class="search-form">
...
<div class="navbar-area">
    ...
    <nav class="navbar navbar-area-2 navbar-area navbar-expand-lg">
        ...
        <div class="container nav-container">
            ...
            <div class="logo">
                <a href="{{route('home',$locale)}}"><img class="iss-logo" style="width:200px;margin-top: -15px; margin-bottom: -15px" src="{{asset('front/assets/img/logo-iss.png')}}" alt="img"></a>
            </div>
            ...
            <div class="nav-right-part nav-right-part-desktop style-black">
                ...
                @endguest
                    @auth()
                        <div class="dropdown">
                            <a style="border: 1px solid rgba(255, 255, 255, 0.2)" class="dashboard"
                               title="{{\Illuminate\Support\Facades\Auth::user()->first_name.' '.\Illuminate\Support\Facades\Auth::user()->last_name}}"
                               href="{{route('dashboard',$locale)}}"><i class="fa fa-user"></i></a>
