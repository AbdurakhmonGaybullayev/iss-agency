...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.mainHeader.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.main-headers.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="slogan_uz">{{ trans('cruds.mainHeader.fields.slogan_uz') }}</label>
                <input class="form-control {{ $errors->has('slogan_uz') ? 'is-invalid' : '' }}" type="text" name="slogan_uz" id="slogan_uz" value="{{ old('slogan_uz', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('slogan_ru') ? 'is-invalid' : '' }}" type="text" name="slogan_ru" id="slogan_ru" value="{{ old('slogan_ru', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('slogan_en') ? 'is-invalid' : '' }}" type="text" name="slogan_en" id="slogan_en" value="{{ old('slogan_en', '') }}" required>
            ...
            <div class="form-group">
                <label for="background_image">{{ trans('cruds.mainHeader.fields.background_image') }}</label>
