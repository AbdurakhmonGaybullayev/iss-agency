        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.universities.store") }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('rank') ? 'is-invalid' : '' }}" type="number" name="rank" id="rank" value="{{ old('rank', '') }}" step="1" required>
                    @if($errors->has('rank'))
                        <div class="invalid-feedback">
                            {{ $errors->first('rank') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('article_description_uz') ? 'is-invalid' : '' }}" name="article_description_uz" id="article_description_uz" required>{!! old('article_description_uz') !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('article_description_ru') ? 'is-invalid' : '' }}" name="article_description_ru" id="article_description_ru" required>{!! old('article_description_ru') !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('article_description_en') ? 'is-invalid' : '' }}" name="article_description_en" id="article_description_en" required>{!! old('article_description_en') !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('ielts') ? 'is-invalid' : '' }}" type="number" name="ielts" id="ielts" value="{{ old('ielts', '') }}" step="0.5" required>
                    @if($errors->has('ielts'))
                        <div class="invalid-feedback">
                            {{ $errors->first('ielts') }}
                        </div>
