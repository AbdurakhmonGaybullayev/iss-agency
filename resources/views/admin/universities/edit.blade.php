    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.universities.update", [$university->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('short_description_ru') ? 'is-invalid' : '' }}" name="short_description_ru" id="short_description_ru">{{ old('short_description_ru', $university->short_description_ru) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('short_description_en') ? 'is-invalid' : '' }}" name="short_description_en" id="short_description_en">{{ old('short_description_en', $university->short_description_en) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('article_description_uz') ? 'is-invalid' : '' }}" name="article_description_uz" id="article_description_uz">{!! old('article_description_uz', $university->article_description_uz) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('article_description_ru') ? 'is-invalid' : '' }}" name="article_description_ru" id="article_description_ru">{!! old('article_description_ru', $university->article_description_ru) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('article_description_en') ? 'is-invalid' : '' }}" name="article_description_en" id="article_description_en">{!! old('article_description_en', $university->article_description_en) !!}</textarea>
