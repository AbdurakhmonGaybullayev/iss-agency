    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.galleries.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('short_description_uz') ? 'is-invalid' : '' }}" type="text" name="short_description_uz" id="short_description_uz" value="{{ old('short_description_uz', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('short_description_ru') ? 'is-invalid' : '' }}" type="text" name="short_description_ru" id="short_description_ru" value="{{ old('short_description_ru', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('short_description_en') ? 'is-invalid' : '' }}" type="text" name="short_description_en" id="short_description_en" value="{{ old('short_description_en', '') }}" required>
