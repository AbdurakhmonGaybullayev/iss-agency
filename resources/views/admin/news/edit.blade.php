...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.news.update", [$news->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="article_uz">{{ trans('cruds.news.fields.article_uz') }}</label>
                <textarea class="form-control ckeditor {{ $errors->has('article_uz') ? 'is-invalid' : '' }}" name="article_uz" id="article_uz">{!! old('article_uz', $news->article_uz) !!}</textarea>
            ...
            <div class="form-group">
                <label for="article_ru">{{ trans('cruds.news.fields.article_ru') }}</label>
                <textarea class="form-control ckeditor {{ $errors->has('article_ru') ? 'is-invalid' : '' }}" name="article_ru" id="article_ru">{!! old('article_ru', $news->article_ru) !!}</textarea>
            ...
            <div class="form-group">
                <label for="article_en">{{ trans('cruds.news.fields.article_en') }}</label>
                <textarea class="form-control ckeditor {{ $errors->has('article_en') ? 'is-invalid' : '' }}" name="article_en" id="article_en">{!! old('article_en', $news->article_en) !!}</textarea>
