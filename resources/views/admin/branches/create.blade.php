...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.branches.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="phone_number">{{ trans('cruds.branch.fields.phone_number') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.branch.fields.phone_number_helper') }}</span>
            </div>
            <div class="form-group">
                <label class="required" for="email">{{ trans('cruds.branch.fields.email') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.branch.fields.email_helper') }}</span>
            </div>
            <div class="form-group">
                <label class="required" for="working_hours">{{ trans('cruds.branch.fields.working_hours') }}</label>
                <input class="form-control {{ $errors->has('working_hours') ? 'is-invalid' : '' }}" type="text" name="working_hours" id="working_hours" value="{{ old('working_hours', '') }}" required>
                @if($errors->has('working_hours'))
                    <div class="invalid-feedback">
                        {{ $errors->first('working_hours') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.branch.fields.working_hours_helper') }}</span>
            </div>
            <div class="form-group">
