...
@section('title')
    {{$university['name_'.$locale]}}
@endsection
@section('meta')
    <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">

    <meta property="og:url" content="{{URL::full()}}">
    <meta property="og:title" content="{{$university['name_'.$locale]}} - issagency.uz">
    <meta property="og:description" content="{{$university['short_description_'.$locale]}}">
    <meta property="og:image" content="{{$university->image->getUrl()}}">
    <meta property="og:type" content="article">
    <meta name="description" content="{{$university->image->getUrl()}}">
    <meta name="keywords" content="{{$university['seo_keywords_'.$locale]}}">
                ...
                <div class="col-lg-4">
                    <div class="td-sidebar">
                        <div class="widget widget_feature">
                            ...
                            <ul>
                                <li>
                                    <i class="fa fa-globe"></i><span>{{__('Country')}}:</span> {{$university->country['name_'.$locale]}}
                                </li>
                                <li><i class="fa fa-star"></i><span>{{__('Ranking')}}:</span> {{$university->rank}}
                                </li>
                                <li>
                                    <i class="fa fa-clipboard"></i><span>{{__('IELTS')}}:</span> @if($university->ielts == 0){{__('Not need')}}@else{{$university->ielts}}@endif
                                </li>
                                <li><i class="fa fa-clone"></i><span>{{__('Programs')}}:</span><br>
                                    @foreach($universityPrograms as $key => $universityProgram)
                                        <span>{{$universityProgram['name_'.$locale].':'}}</span><br>
                                        @php $directions = ''; @endphp

                                        @foreach($university->directions as $key => $direction)
                                            @if(\Illuminate\Support\Facades\DB::table('direction_programm')->where('programm_id',$universityProgram->id)->where('direction_id',$direction->id)->count() > 0)
                                                @php $directions = $directions . '&emsp;&emsp;' . $direction->name_uz . ',<br>' @endphp
                                            @endif
                                        @endforeach
                            ...
                            <div class="price-wrap text-center">
                                ...
                                <a class="btn btn-base btn-radius"
                                   href="{{route('admission',['lang'=>$locale,'id'=>$university->id])}}">{{__('Admission')}}</a>
                            </div>
                        </div>
                            ...
                            <div class="widget widget_catagory">
                                ...
                                <ul class="catagory-items">
                                    @foreach($countries as $country)
                                        <li>
                                            <a href="{{route('programs',$locale).'?country='.$country->id}}">{{$country['name_'.$locale]}}
