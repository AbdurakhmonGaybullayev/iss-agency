    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.testimonials.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('text_uz') ? 'is-invalid' : '' }}" name="text_uz" id="text_uz" required>{{ old('text_uz') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('text_ru') ? 'is-invalid' : '' }}" name="text_ru" id="text_ru" required>{{ old('text_ru') }}</textarea>
