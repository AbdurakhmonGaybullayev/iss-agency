...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.cooperationOfferText.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.cooperation-offer-texts.update", [$cooperationOfferText->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="title_uz">{{ trans('cruds.cooperationOfferText.fields.title_uz') }}</label>
                <input class="form-control {{ $errors->has('title_uz') ? 'is-invalid' : '' }}" type="text" name="title_uz" id="title_uz" value="{{ old('title_uz', $cooperationOfferText->title_uz) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title_ru') ? 'is-invalid' : '' }}" type="text" name="title_ru" id="title_ru" value="{{ old('title_ru', $cooperationOfferText->title_ru) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title_en') ? 'is-invalid' : '' }}" type="text" name="title_en" id="title_en" value="{{ old('title_en', $cooperationOfferText->title_en) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('offer_uz') ? 'is-invalid' : '' }}" name="offer_uz" id="offer_uz" required>{{ old('offer_uz', $cooperationOfferText->offer_uz) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('offer_ru') ? 'is-invalid' : '' }}" name="offer_ru" id="offer_ru" required>{{ old('offer_ru', $cooperationOfferText->offer_ru) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('offer_en') ? 'is-invalid' : '' }}" name="offer_en" id="offer_en" required>{{ old('offer_en', $cooperationOfferText->offer_en) }}</textarea>
