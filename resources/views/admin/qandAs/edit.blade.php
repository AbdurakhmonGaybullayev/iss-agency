    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.qand-as.update", [$qandA->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number') ? 'is-invalid' : '' }}" type="number" name="number" id="number" value="{{ old('number', $qandA->number) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('question_uz') ? 'is-invalid' : '' }}" name="question_uz" id="question_uz" required>{{ old('question_uz', $qandA->question_uz) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('question_ru') ? 'is-invalid' : '' }}" name="question_ru" id="question_ru">{{ old('question_ru', $qandA->question_ru) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('question_en') ? 'is-invalid' : '' }}" name="question_en" id="question_en">{{ old('question_en', $qandA->question_en) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('answer_uz') ? 'is-invalid' : '' }}" name="answer_uz" id="answer_uz" required>{{ old('answer_uz', $qandA->answer_uz) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('answer_ru') ? 'is-invalid' : '' }}" name="answer_ru" id="answer_ru" required>{{ old('answer_ru', $qandA->answer_ru) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('answer_en') ? 'is-invalid' : '' }}" name="answer_en" id="answer_en" required>{{ old('answer_en', $qandA->answer_en) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('seo_keywords_uz') ? 'is-invalid' : '' }}" value="{{ old('seo_keywords_uz', $qandA->seo_keywords_uz) }}" name="seo_keywords_uz" id="seo_keywords_uz" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('seo_keywords_ru') ? 'is-invalid' : '' }}" value="{{ old('seo_keywords_ru', $qandA->seo_keywords_ru) }}" name="seo_keywords_ru" id="seo_keywords_ru" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('seo_keywords_en') ? 'is-invalid' : '' }}" value="{{ old('seo_keywords_en', $qandA->seo_keywords_en) }}" name="seo_keywords_en" id="seo_keywords_en" required>
