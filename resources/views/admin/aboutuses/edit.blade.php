        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.aboutuses.update", [$aboutus->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('title_uz') ? 'is-invalid' : '' }}" type="text" name="title_uz" id="title_uz" value="{{ old('title_uz', $aboutus->title_uz) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('title_ru') ? 'is-invalid' : '' }}" type="text" name="title_ru" id="title_ru" value="{{ old('title_ru', $aboutus->title_ru) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('title_en') ? 'is-invalid' : '' }}" type="text" name="title_en" id="title_en" value="{{ old('title_en', $aboutus->title_en) }}" required>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('short_description_uz') ? 'is-invalid' : '' }}" name="short_description_uz" id="short_description_uz" required>{{ old('short_description_uz', $aboutus->short_description_uz) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('short_description_ru') ? 'is-invalid' : '' }}" name="short_description_ru" id="short_description_ru" required>{{ old('short_description_ru', $aboutus->short_description_ru) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('short_description_en') ? 'is-invalid' : '' }}" name="short_description_en" id="short_description_en" required>{{ old('short_description_en', $aboutus->short_description_en) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('advantages_uz') ? 'is-invalid' : '' }}" type="text" name="advantages_uz" id="advantages_uz" value="{{ old('advantages_uz', $aboutus->advantages_uz) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('advantages_ru') ? 'is-invalid' : '' }}" type="text" name="advantages_ru" id="advantages_ru" value="{{ old('advantages_ru', $aboutus->advantages_ru) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('advantages_en') ? 'is-invalid' : '' }}" type="text" name="advantages_en" id="advantages_en" value="{{ old('advantages_en', $aboutus->advantages_en) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('success_students') ? 'is-invalid' : '' }}" type="number" name="success_students" id="success_students" value="{{ old('success_students', $aboutus->success_students) }}" step="1" required>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('statistics_short_description_uz') ? 'is-invalid' : '' }}" name="statistics_short_description_uz" id="statistics_short_description_uz" required>{{ old('statistics_short_description_uz', $aboutus->statistics_short_description_uz) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('statistics_short_description_ru') ? 'is-invalid' : '' }}" name="statistics_short_description_ru" id="statistics_short_description_ru" required>{{ old('statistics_short_description_ru', $aboutus->statistics_short_description_ru) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('statistics_short_description_en') ? 'is-invalid' : '' }}" name="statistics_short_description_en" id="statistics_short_description_en" required>{{ old('statistics_short_description_en', $aboutus->statistics_short_description_en) }}</textarea>
                ...
                <div class="form-group">
                    <label class="required" for="article_uz">{{ trans('cruds.aboutUs.fields.article_uz') }}</label>
                    <textarea class="form-control ckeditor {{ $errors->has('article_uz') ? 'is-invalid' : '' }}" name="article_uz" id="article_uz" required>{!! old('article_uz', $aboutus->article_uz) !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('article_ru') ? 'is-invalid' : '' }}" name="article_ru" id="article_ru" required>{{ old('article_ru', $aboutus->article_ru) }}</textarea>
                ...
                <div class="form-group">
                    <label class="required" for="article_en">{{ trans('cruds.aboutUs.fields.article_en') }}</label>
                    <textarea class="form-control ckeditor {{ $errors->has('article_en') ? 'is-invalid' : '' }}" name="article_en" id="article_en" required>{!! old('article_en', $aboutus->article_en) !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('footer_text_uz') ? 'is-invalid' : '' }}" name="footer_text_uz" id="footer_text_uz" required>{{ old('footer_text_uz', $aboutus->footer_text_uz) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('footer_text_ru') ? 'is-invalid' : '' }}" name="footer_text_ru" id="footer_text_ru" required>{{ old('footer_text_ru', $aboutus->footer_text_ru) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('footer_text_en') ? 'is-invalid' : '' }}" name="footer_text_en" id="footer_text_en" required>{{ old('footer_text_en', $aboutus->footer_text_en) }}</textarea>
