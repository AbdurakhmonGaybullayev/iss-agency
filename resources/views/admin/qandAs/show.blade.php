        ...
        <div class="form-group">
            ...
            <table class="table table-bordered table-striped">
                <tbody>
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.qandA.fields.seo_keywords_uz') }}
                        </th>
                        <td>
                            {{ $qandA->seo_keywords_uz }}
                        </td>
                    </tr>
                    <tr>
                        <th>
                            {{ trans('cruds.qandA.fields.seo_keywords_ru') }}
                        </th>
                        <td>
                            {{ $qandA->seo_keywords_ru }}
                        </td>
                    </tr>
                    <tr>
                        <th>
                            {{ trans('cruds.qandA.fields.seo_keywords_en') }}
                        </th>
                        <td>
                            {{ $qandA->seo_keywords_en }}
                        </td>
                    </tr>
                </tbody>
            </table>
