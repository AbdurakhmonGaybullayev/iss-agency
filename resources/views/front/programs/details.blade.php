        ...
        <div class="container">
                    ...
                    <div class="course-course-detaila-inner">
                        ...
                        <div class="course-details-nav-tab text-center">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="tab2-tab" data-toggle="tab" href="#tab2" role="tab" aria-controls="tab2" aria-selected="false">Curriculum</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="tab3-tab" data-toggle="tab" href="#tab3" role="tab" aria-controls="tab3" aria-selected="false">FAQ</a>
                                </li>
                                <li class="nav-item">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="#">
                                                        ...
                                                        <span class="progress-bar-inner">
                                                            <span class="progress">
                                                                <span class="progress-bar" role="progressbar" aria-valuenow="0"
                                                                      aria-valuemin="0" aria-valuemax="100" style="width:0%"></span>
                                                            </span>
                                                        </span>
                                                        <span class="counter-count">0%</span>
                    ...
                    <div class="td-sidebar">
                        ...
                        <div class="widget widget_catagory">
                            ...
                            <div class="single-course-inner">
                                <div class="thumb">
                                    <img src="{{asset('front/assets/img/course/1.png')}}" alt="img">
                                </div>
                                <div class="details">
                                    <div class="details-inner">
                                        <div class="emt-user">
            ...
            <div class="row justify-content-center pd-top-100">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-course-inner">
                        <div class="thumb">
                            <img src="{{asset('front/assets/img/course/2.png')}}" alt="img">
                        </div>
                        <div class="details">
                            <div class="details-inner">
                                <div class="emt-user">
                                    <span class="u-thumb"><img src="{{asset('front/assets/img/author/2.png')}}" alt="img"></span>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-course-inner">
                        <div class="thumb">
                            <img src="{{asset('front/assets/img/course/3.png')}}" alt="img">
                        </div>
                        <div class="details">
                            <div class="details-inner">
                                <div class="emt-user">
                                    <span class="u-thumb"><img src="{{asset('front/assets/img/author/3.png')}}" alt="img"></span>
