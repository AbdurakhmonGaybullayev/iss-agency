        ...
        <div class="form-group">
            ...
            <table class="table table-bordered table-striped">
                <tbody>
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.gallery.fields.seo_keywords_uz') }}
                        </th>
                        <td>
                            {{ $gallery->seo_keywords_uz }}
                        </td>
                    </tr>
                    <tr>
                        <th>
                            {{ trans('cruds.gallery.fields.seo_keywords_ru') }}
                        </th>
                        <td>
                            {{ $gallery->seo_keywords_ru }}
                        </td>
                    </tr>
                    <tr>
                        <th>
                            {{ trans('cruds.gallery.fields.seo_keywords_en') }}
                        </th>
                        <td>
                            {{ $gallery->seo_keywords_en }}
                        </td>
                    </tr>
                </tbody>
            </table>
